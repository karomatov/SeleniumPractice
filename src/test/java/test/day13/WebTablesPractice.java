...
public class WebTablesPractice {
    ...
    public void test2() {
        ...
        System.out.println("Actual: " + actualColumnNumber + " Expected: " + expectedColumnNumber);
    }

    @Test(description = "Verify that number of rows or equals to 5")
    public void test3(){
        ...
        System.out.println("Expected: " + expectedRowCount+" Actual: "+ actualRowCount);
